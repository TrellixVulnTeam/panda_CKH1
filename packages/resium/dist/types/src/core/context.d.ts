...
export declare const withContext: <P, C>(Component: React.ComponentType<WithContextProps<P, C>>) => React.ForwardRefExoticComponent<React.PropsWithoutRef<P> & React.RefAttributes<React.ComponentType<WithContextProps<P, C>>>>;
