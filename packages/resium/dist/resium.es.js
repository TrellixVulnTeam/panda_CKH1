...
var NightVisionStage = createPostProcessStage({
    ...
    create: function (props) {
        return Cesium.PostProcessStageLibrary.createNightVisionStage(props.stages);
    },
});
var SilhouetteStage = createPostProcessStage({
    ...
    readonlyProps: ["stages"],
    create: function (props) {
        return Cesium.PostProcessStageLibrary.createSilhouetteStage(props.stages);
    },
});
...
export { createCesiumComponent, createCameraOperation as CameraOperation, Billboard, BillboardCollection, BillboardGraphics, BoxGraphics, Camera, CameraFlyHome, CameraFlyTo, CameraFlyToBoundingSphere, Cesium3DTileset, CesiumWidget$1 as CesiumWidget, Clock, CorridorGraphics, CustomDataSource, CylinderGraphics, CzmlDataSource, DefaultScreenSpaceEventHandler, EllipseGraphics, EllipsoidGraphics, Entity$1 as Entity, EntityDescription$1 as EntityDescription, Fog, GeoJsonDataSource, Globe, ImageryLayer, ImageryLayerCollection, KmlDataSource, Label, LabelCollection, LabelGraphics, Model, ModelGraphics, Moon, ParticleSystem, PathGraphics, PlaneGraphics, PointGraphics, PointPrimitive, PointPrimitiveCollection, PolygonGraphics, Polyline$1 as Polyline, PolylineCollection, PolylineGraphics, PolylineVolumeGraphics, PostProcessStage, BlackAndWhiteStage, BlurStage, BrightnessStage, DepthOfFieldStage, EdgeDetectionStage, LensFlareStage, Fxaa, NightVisionStage, SilhouetteStage, PostProcessStageComposite, AmbientOcclusion, Bloom, Primitive, RectangleGraphics, Scene, ScreenSpaceCameraController, ScreenSpaceEvent$1 as ScreenSpaceEvent, ScreenSpaceEventHandler$1 as ScreenSpaceEventHandler, Sun, TimeDynamicPointCloud, Viewer$1 as Viewer, WallGraphics, Provider, Consumer, withCesium, attachEvents, detachEvents, updateEvents, getEventProps, eventNames };
